    ...
    def _get_frame_from_anno(self, anno):
        ...
        try:
            try:
                ...
                # self.velos[scene_id][frame_id] = pc  #Tye: will occupy a lot of memories
